      ...
      return this.each(function () {
        ...
        d.createInput = function () {
          ...
          j.bind("change", function () {
            ...
            d.queue.selected = l;
            if (
              d.queue.count + l > f.queueSizeLimit &&
              f.queueSizeLimit !== 0
            ) {
        ...
        if (f.itemTemplate == false) {
          d.queueItem = b(
            '<div class="uploadifive-queue-item">                        <a class="close" href="#">X</a>                        <div><span class="filename"></span><span class="fileinfo"></span></div>                        <div class="progress">                            <div class="progress-bar"></div>                        </div>                    </div>'
          );
        } else {
        ...
        if (
          ...
          if (!f.queueID) {
            ...
            d.queueEl = b(
              '<div id="' + f.queueID + '" class="uploadifive-queue" />'
            );
    ...
    upload: function (c, d) {
      this.each(function () {
        ...
        if (c) {
          ...
          if (
            e.uploads.count + e.uploads.current < f.uploadLimit ||
            f.uploadLimit == 0
          ) {
            if (!d) {
            ...
            b("#" + f.queueID)
              ...
              .each(function () {
                ...
                if (
                  (e.uploads.current >= f.simUploadLimit &&
                    f.simUploadLimit !== 0) ||
