...
*/ !(function (e) {
  "undefined" == typeof e.fn.each2 &&
    e.extend(e.fn, {
      each2: function (t) {
        for (
          var s = e([0]), i = -1, n = this.length;
          ++i < n && (s.context = s[0] = this[i]) && t.call(s[0], i, s) !== !1;
  ...
  (function (e, t) {
    ...
    function l(s) {
      ...
      s.on("keydown", function () {
        ...
        s.on("keyup", function () {
          ...
          n !== t &&
            s.val() !== n &&
            (e.removeData(s, i), s.trigger("keyup-change"));
        });
    }
    function h(s) {
      s.on("mousemove", function (s) {
        var i = F;
        (i === t || i.x !== s.pageX || i.y !== s.pageY) &&
          e(s.target).trigger("mousemove-filtered", s);
      });
    }
    function u(e, s, i) {
      i = i || t;
        ...
        window.setTimeout(function () {
          ...
          n &&
            ...
            (s.setSelectionRange
              ...
              : s.createTextRange &&
                ((t = s.createTextRange()), t.collapse(!1), t.select()));
        }, 0);
    }
    function f(t) {
      t = e(t)[0];
      ...
      if ("selectionStart" in t)
        (s = t.selectionStart), (i = t.selectionEnd - s);
    ...
    function w(t, s, i) {
      var n,
        o,
        a = [];
      (n = e.trim(t.attr("class"))),
        n &&
          ((n = "" + n),
          e(n.split(/\s+/)).each2(function () {
            0 === this.indexOf("select2-") && a.push(this);
          })),
        (n = e.trim(s.attr("class"))),
        n &&
          ((n = "" + n),
          e(n.split(/\s+/)).each2(function () {
    ...
    function b(e, t, s, n) {
      ...
      return 0 > o
        ...
        : (s.push(n(e.substring(0, o))),
          ...
          s.push(n(e.substring(o, o + a))),
          s.push("</span>"),
          void s.push(n(e.substring(o + a, e.length))));
    }
    function C(e) {
      var t = {
        "\\": "&#92;",
      ...
      return function (c) {
        window.clearTimeout(i),
          (i = window.setTimeout(function () {
            ...
            (i = i ? i.call(r, c.term, c.page, c.context) : null),
              (o =
                "function" == typeof o
                  ? o.call(r, c.term, c.page, c.context)
                  : o),
              n && "function" == typeof n.abort && n.abort(),
              s.params &&
                (e.isFunction(s.params)
                  ? e.extend(u, s.params.call(r))
                  : e.extend(u, s.params)),
              e.extend(u, {
                url: o,
                dataType: s.dataType,
        ...
        e.isArray(r) &&
          (e(r).each(function () {
            var e = this.text !== t,
              s = e ? this.text : this;
            ("" === o || n.matcher(o, s)) &&
              a.results.push(e ? this : { id: this, text: this });
          }),
          n.callback(a));
      };
    }
    ...
    function P(e, s, i, n) {
      ...
      for (;;) {
        for (
          r = -1, c = 0, l = n.tokenSeparators.length;
          l > c && ((h = n.tokenSeparators[c]), (r = e.indexOf(h)), !(r >= 0));
          c++
        );
        if (0 > r) break;
        if (
          ...
          o.length > 0 &&
            ((o = n.createSearchChoice.call(this, o, s)),
            o !== t && null !== o && n.id(o) !== t && null !== n.id(o)))
        ) {
      ...
      (L = e(document)),
        ...
        (A = k(Object, {
          ...
          init: function (s) {
            ...
            (this.opts = s = this.prepareOpts(s)),
              ...
              (this.containerId =
                "s2id_" + (s.element.attr("id") || "autogen" + H())),
              ...
              this.container.css(T(s.containerCss, this.opts.element)),
              this.container.addClass(
                T(s.containerCssClass, this.opts.element)
              ),
              ...
              this.dropdown.addClass(T(s.dropdownCssClass, this.opts.element)),
              ...
              e.fn.mousewheel &&
                i.mousewheel(function (e, t, s, n) {
                  var o = i.scrollTop();
                  n > 0 && 0 >= o - n
                    ? (i.scrollTop(0), g(e))
                    : 0 > n &&
                      i.get(0).scrollHeight - i.scrollTop() + n <= i.height() &&
                      (i.scrollTop(i.get(0).scrollHeight - i.height()), g(e));
                }),
              l(n),
              ...
              this.dropdown.on(
                ...
                this.bind(function (t) {
                  e(t.target).closest(".select2-result-selectable").length >
                    0 &&
          ...
          optionToData: function (e) {
            return e.is("option")
              ? {
                  ...
                  locked:
                    a(e.attr("locked"), "locked") || a(e.data("locked"), !0),
                }
              : e.is("optgroup")
              ? {
                  text: e.attr("label"),
          ...
          prepareOpts: function (s) {
            ...
            if (
              ((i = s.element),
              "select" === i.get(0).tagName.toLowerCase() &&
                (this.select = n = s.element),
              n &&
                e.each(
                  [
                    "id",
                    ...
                    (a = function (i, n, h) {
                      ...
                      for (u = 0, d = i.length; d > u; u += 1)
                        (p = i[u]),
                          (g = p.disabled === !0),
                          (f = !g && r(p) !== t),
                          (m = p.children && p.children.length > 0),
                          (v = e("<li></li>")),
                          v.addClass("select2-results-dept-" + h),
                          ...
                          w.addClass("select2-result-label"),
                          w.attr("id", "select2-result-label-" + H()),
                          w.attr("role", "option"),
                          (C = s.formatResult(p, w, o, l.opts.escapeMarkup)),
                          C !== t && (w.html(C), v.append(w)),
                          m &&
                            ((b = e("<ul></ul>")),
            ...
            if (
              (n
                ? ((s.query = this.bind(function (e) {
                    ...
                    (o = function (t, s) {
                      var i;
                      t.is("option")
                        ? e.matcher(r, t.text(), t) && s.push(l.optionToData(t))
                        : t.is("optgroup") &&
                          ((i = l.optionToData(t)),
                      ...
                      (s = i.children()),
                      this.getPlaceholder() !== t &&
                        s.length > 0 &&
                        ((n = this.getPlaceholderOption()),
                        n && (s = s.not(n))),
                ...
                : "query" in s ||
                  ("ajax" in s
                    ? ((c = s.element.data("ajax-url")),
                      c && c.length > 0 && (s.ajax.url = c),
                      (s.query = S.call(s.element, s.ajax)))
                    : "data" in s
                    ? (s.query = y(s.data))
                    : "tags" in s &&
                      ((s.query = x(s.tags)),
                      s.createSearchChoice === t &&
                        (s.createSearchChoice = function (t) {
                          return { id: e.trim(t), text: e.trim(t) };
                        }),
                      s.initSelection === t &&
                        (s.initSelection = function (t, i) {
                          var n = [];
                          e(r(t.val(), s.separator, s.transformVal)).each(
                            function () {
                              var t = { id: this, text: this },
                                i = s.tags;
                              e.isFunction(i) && (i = i()),
                                e(i).each(function () {
                                  return a(this.id, t.id)
                                    ? ((t = this), !1)
                                    : void 0;
                                }),
                                n.push(t);
              ...
              throw (
                "query function not defined for Select2 " + s.element.attr("id")
              );
            if ("top" === s.createSearchChoicePosition)
              s.createSearchChoicePosition = function (e, t) {
                e.unshift(t);
              };
            ...
            i.on(
              ...
              s !== t &&
                (this.propertyObserver &&
                  ...
                  (this.propertyObserver = null)),
                (this.propertyObserver = new s(function (t) {
                  e.each(t, n._sync);
                })),
          ...
          enableInterface: function () {
            var e = this._enabled && !this._readonly,
              t = !e;
            return e === this.enabledInterface
              ? !1
          ...
          positionDropdown: function () {
            ...
            E
              ...
              this.opts.dropdownAutoWidth
                ? ((o = e(".select2-results", a)[0]),
                  a.addClass("select2-drop-auto-width"),
                  a.css("width", ""),
                  (S =
                    a.outerWidth(!1) +
                    (o.scrollHeight === o.clientHeight ? 0 : N.width)),
                  S > h ? (h = S) : (S = h),
                  (u = a.outerHeight(!1)))
                : this.container.removeClass("select2-drop-auto-width"),
              "static" !== this.body.css("position") &&
                ((t = this.body.offset()), (v -= t.top), (w -= t.left)),
              !y() && x() && (w = c.left + this.container.outerWidth(!1) - S),
              (n = { left: w, width: h }),
              s
                ? ((n.top = c.top - u),
                  (n.bottom = "auto"),
              ...
              (n = e.extend(n, T(this.opts.dropdownCss, this.opts.element))),
              a.css(n);
          },
          shouldOpen: function () {
            var t;
          ...
          open: function () {
            return this.shouldOpen()
              ? (this.opening(),
                L.on("mousemove.select2Event", function (e) {
            ...
            this.container
              ...
              0 === t.length &&
                ...
                t.on("mousedown touchstart click", function (i) {
                  ...
                  o.length > 0 &&
                    ((n = o.data("select2")),
                    n.opts.selectOnBlur && n.selectHighlighted({ noFocus: !0 }),
                    n.close(),
                    i.preventDefault(),
                    i.stopPropagation());
                })),
          ...
          ensureHighlightVisible: function () {
            ...
            if (((s = this.highlight()), !(0 > s))) {
              ...
              (t = this.findHighlightableChoices().find(
                ...
                (n = c + i.outerHeight(!0)),
                s === t.length - 1 &&
                  ((r = l.find("li.select2-more-results")),
                  r.length > 0 && (n = r.offset().top + r.outerHeight(!0))),
                (o = l.offset().top + l.outerHeight(!1)),
          ...
          moveHighlight: function (t) {
            for (
              var s = this.findHighlightableChoices(), i = this.highlight();
              i > -1 && i < s.length;
          ...
          highlight: function (t) {
            ...
            return 0 === arguments.length
              ? n(o.filter(".select2-highlighted")[0], o.get())
              : (t >= o.length && (t = o.length - 1),
                ...
                this.search.attr(
                  ...
                  s.find(".select2-result-label").attr("id")
                ),
                    ...
                    n.opened() &&
                      ...
                      e.more === !0
                        ? (s
                            ...
                            .html(
                              n.opts.escapeMarkup(
                                T(n.opts.formatLoadMore, n.opts.element, i + 1)
                              )
                            ),
                          window.setTimeout(function () {
                            n.loadMoreIfNeeded();
          ...
          updateResults: function (s) {
            ...
            if (
              ...
              if (
                ...
                e.isArray(o) &&
                  o.length >= g &&
                  E(u.formatSelectionTooBig, "formatSelectionTooBig"))
              )
                return void n(
                  "<li class='select2-selection-limit'>" +
                    T(u.formatSelectionTooBig, u.element, g) +
                    "</li>"
                );
              if (l.val().length < u.minimumInputLength)
                return (
                  n(
                    E(u.formatInputTooShort, "formatInputTooShort")
                      ? "<li class='select2-no-results'>" +
                          T(
                            u.formatInputTooShort,
                            u.element,
                            l.val(),
              ...
              if (u.maximumInputLength && l.val().length > u.maximumInputLength)
                return void n(
                  E(u.formatInputTooLong, "formatInputTooLong")
                    ? "<li class='select2-no-results'>" +
                        T(
                          u.formatInputTooLong,
                          u.element,
                          l.val(),
                ...
                u.query({
                  ...
                  callback: this.bind(function (o) {
                    ...
                    if (c == this.queryCount) {
                      ...
                      if (
                        o.hasError !== t &&
                        E(u.formatAjaxError, "formatAjaxError")
                      )
                        return void n(
                      ...
                      if (
                        ...
                        this.opts.createSearchChoice &&
                          "" !== l.val() &&
                          ((r = this.opts.createSearchChoice.call(
                            d,
                            l.val(),
                            o.results
                          )),
                        ...
                        0 === o.results.length &&
                          E(u.formatNoMatches, "formatNoMatches"))
                      )
                        return void n(
                          "<li class='select2-no-results'>" +
                            T(u.formatNoMatches, u.element, l.val()) +
                            "</li>"
                        );
                      h.empty(),
                        d.opts.populateResults.call(this, h, o.results, {
                          term: l.val(),
                          page: this.resultsPage,
                          context: null,
                        }),
                        o.more === !0 &&
                          E(u.formatLoadMore, "formatLoadMore") &&
                          (h.append(
                            "<li class='select2-more-results'>" +
                              u.escapeMarkup(
                                T(u.formatLoadMore, u.element, this.resultsPage)
                              ) +
                              "</li>"
                          ),
                          window.setTimeout(function () {
          ...
          selectHighlighted: function (e) {
            ...
            i
              ? (this.highlight(t), this.onSelect(i, e))
          ...
          getPlaceholder: function () {
            ...
            return (
              ...
              ((e = this.getPlaceholderOption()) !== t ? e.text() : t)
            );
          },
        ...
        (R = k(A, {
          ...
          opening: function () {
            ...
            this.opts.minimumResultsForSearch >= 0 && this.showSearch(!0),
              ...
              this.opts.shouldFocusInput(this) &&
                ...
                (s = this.search.get(0)),
                s.createTextRange
                  ? ((i = s.createTextRange()), i.collapse(!1), i.select())
                  : s.setSelectionRange &&
          ...
          destroy: function () {
            e("label[for='" + this.focusser.attr("id") + "']").attr(
              ...
              I.call(this, "selection", "focusser");
          },
          initContainer: function () {
            ...
            this.showSearch(this.opts.minimumResultsForSearch < 0 ? !1 : !0),
              ...
              t.find(".select2-chosen").attr("id", "select2-chosen-" + a),
              ...
              (i = e("label[for='" + this.opts.element.attr("id") + "']")),
            ...
            this.opts.element.attr("title", r || i.text()),
              ...
              this.search.on(
                ...
                this.bind(function (e) {
                  if (this.isInterfaceEnabled() && 229 != e.keyCode) {
                    if (e.which === U.PAGE_UP || e.which === U.PAGE_DOWN)
                      return void g(e);
                    switch (e.which) {
                      case U.UP:
                      case U.DOWN:
                        return (
                          this.moveHighlight(e.which === U.UP ? -1 : 1),
                          void g(e)
                        );
                      case U.ENTER:
              ...
              this.focusser.on(
                ...
                this.bind(function (e) {
                  if (
                    ...
                    if (this.opts.openOnEnter === !1 && e.which === U.ENTER)
                      return void g(e);
                    if (
                      e.which == U.DOWN ||
                      e.which == U.UP ||
                      (e.which == U.ENTER && this.opts.openOnEnter)
                    ) {
                      if (e.altKey || e.ctrlKey || e.shiftKey || e.metaKey)
                        return;
                      return this.open(), void g(e);
                    }
                    return e.which == U.DELETE || e.which == U.BACKSPACE
          ...
          clear: function (t) {
            ...
            if (s) {
              ...
              if ((this.opts.element.trigger(i), i.isDefaultPrevented()))
                return;
          ...
          isPlaceholderOptionSelected: function () {
            var e;
            return this.getPlaceholder() === t
              ? !1
              : ((e = this.getPlaceholderOption()) !== t &&
                  e.prop("selected")) ||
          ...
          getPlaceholder: function () {
            return this.select && this.getPlaceholderOption() === t
              ? t
          ...
          postprocessResults: function (e, t, s) {
            ...
            if (
              (this.findHighlightableChoices().each2(function (e, t) {
                return a(n.id(t.data("select2-data")), n.opts.element.val())
                  ? ((i = e), !1)
                  : void 0;
              }),
              s !== !1 && this.highlight(t === !0 && i >= 0 ? i : 0),
              t === !0)
            ) {
          ...
          updateSelection: function (e) {
            ...
            this.selection.data("select2-data", e),
              n.empty(),
              null !== e &&
                (s = this.opts.formatSelection(e, n, this.opts.escapeMarkup)),
              s !== t && n.append(s),
          ...
          val: function () {
            ...
            if (
              ...
              this.select
                ...
                this.setPlaceholder(),
                s && this.triggerChange({ added: i, removed: o });
            else {
              ...
              this.opts.element.val(e),
                this.opts.initSelection(this.opts.element, function (e) {
                  n.opts.element.val(e ? n.id(e) : ""),
                    n.updateSelection(e),
                    n.setPlaceholder(),
                    s && n.triggerChange({ added: e, removed: o });
                });
            }
          },
          clearSearch: function () {
              ...
              : (arguments.length > 1 && (i = arguments[1]),
                void (e
                  ? ((s = this.data()),
                    ...
                    this.updateSelection(e),
                    i && this.triggerChange({ added: e, removed: s }))
                  : this.clear(i)));
          },
        })),
        (D = k(A, {
          ...
          destroy: function () {
            e("label[for='" + this.search.attr("id") + "']").attr(
              ...
              this.parent.destroy.apply(this, arguments),
              I.call(this, "searchContainer", "selection");
          },
          initContainer: function () {
            var t,
              s = ".select2-choices";
            ...
            this.selection.on(
                ...
                this.bind(function (e) {
                  if (this.isInterfaceEnabled()) {
                    ...
                    if (
                      ...
                      var a = s;
                      return (
                        e.which == U.LEFT && i.length
                          ? (a = i)
                          : e.which == U.RIGHT
                          ? (a = n.length ? n : null)
                          : e.which === U.BACKSPACE
                          ? this.unselect(s.first()) &&
                            (this.search.width(10), (a = i.length ? i : n))
                          : e.which == U.DELETE
                          ? this.unselect(s.first()) &&
                            (this.search.width(10), (a = n.length ? n : null))
                          : e.which == U.ENTER && (a = null),
                        this.selectChoice(a),
                        g(e),
                    ...
                    if (
                      ((e.which === U.BACKSPACE && 1 == this.keydowns) ||
                        e.which == U.LEFT) &&
                      0 == o.offset &&
                      !o.length
                    )
                    ...
                    if (
                      ...
                      this.open(),
                        (e.which === U.PAGE_UP || e.which === U.PAGE_DOWN) &&
                          g(e),
                        e.which === U.ENTER && g(e);
                    }
                  }
              ...
              this.container.on(
                ...
                this.bind(function (t) {
                  this.isInterfaceEnabled() &&
                    (e(t.target).closest(".select2-search-choice").length > 0 ||
                      (this.selectChoice(null),
            ...
            if (
              ...
              this.opts.initSelection.call(
                ...
                function (s) {
                  s !== t &&
                    null !== s &&
                    (e.updateSelection(s), e.close(), e.clearSearch());
                }
              );
            }
          },
          clearSearch: function () {
            ...
            this.search.hasClass("select2-focused") === !1
              ? (this.search.val(e).addClass("select2-default"),
                this.search.width(s > 0 ? s : this.container.css("width")))
          ...
          tokenize: function () {
            ...
            (e = this.opts.tokenizer.call(
              ...
              null != e &&
                e != t &&
                (this.search.val(e), e.length > 0 && this.open());
          },
          onSelect: function (e, s) {
            this.triggerSelect(e) &&
              ...
              (this.select || !this.opts.closeOnSelect) &&
                this.postprocessResults(e, !1, this.opts.closeOnSelect === !0),
          ...
          addSelectedChoice: function (s) {
            ...
            (i = this.opts.formatSelection(
              ...
              i != t && c.find("div").replaceWith(e("<div></div>").html(i)),
          ...
          unselect: function (t) {
            ...
            if (((t = t.closest(".select2-search-choice")), 0 === t.length))
              throw (
                "Invalid argument: " + t + ". Must be .select2-search-choice"
              );
          ...
          postprocessResults: function (e, t, s) {
            ...
            o.each2(function (e, t) {
              ...
              -1 == this.highlight() &&
                ...
                r.highlight(0),
              !this.opts.createSearchChoice &&
                !o.filter(".select2-result:not(.select2-selected)").length >
                  0 &&
                (!e ||
                  (e &&
                    !e.more &&
                    0 === this.results.find(".select2-no-results").length)) &&
                E(r.opts.formatNoMatches, "formatNoMatches") &&
                this.results.append(
                  "<li class='select2-no-results'>" +
          ...
          getVal: function () {
            var e;
            return this.select
              ? ((e = this.select.val()), null === e ? [] : e)
              : ((e = this.opts.element.val()),
                r(e, this.opts.separator, this.opts.transformVal));
          },
          setVal: function (t) {
            var s;
            this.select
              ...
              : ((s = []),
                ...
                this.opts.element.val(
                  0 === s.length ? "" : s.join(this.opts.separator)
                ));
          },
          buildChangeDetails: function (e, t) {
            for (var t = t.slice(0), e = e.slice(0), s = 0; s < t.length; s++)
              for (var i = 0; i < e.length; i++)
                a(this.opts.id(t[s]), this.opts.id(e[i])) &&
                  (t.splice(s, 1), s > 0 && s--, e.splice(i, 1), i--);
          ...
          val: function (s, i) {
            ...
            if (((n = this.data()), n.length || (n = []), !s && 0 !== s))
              return (
                this.opts.element.val(""),
                this.updateSelection([]),
                this.clearSearch(),
                void (
                  i && this.triggerChange({ added: this.data(), removed: n })
                )
              );
          ...
          return (
            this.each(function () {
              if (0 === c.length || "object" == typeof c[0])
                (s = 0 === c.length ? {} : e.extend({}, c[0])),
                  (s.element = e(this)),
                  "select" === s.element.get(0).tagName.toLowerCase()
                    ? (r = s.element.prop("multiple"))
                    : ((r = s.multiple || !1),
                      "tags" in s && (s.multiple = r = !0)),
                  (i = r
                ...
                if (
                  ...
                  "container" === o
                    ...
                    : "dropdown" === o
                    ? (a = i.dropdown)
                    : (d[o] && (o = d[o]), (a = i[o].apply(i, c.slice(1)))),
                  n(c[0], h) >= 0 || (n(c[0], u) >= 0 && 1 == c.length))
                )
                  return !1;
              }
            }),
        ...
        (e.fn.select2.locales.en = {
          ...
          formatInputTooShort: function (e, t) {
            var s = t - e.length;
            return (
              "Please enter " + s + " or more character" + (1 == s ? "" : "s")
            );
          },
