...
+(function (t) {
  ...
  +(function (t) {
    ...
    function e(e) {
      ...
      var i = "#" !== o ? t(document).find(o) : null;
        ...
        if (
          ...
          if (
            ...
            var a = " li:not(.disabled):visible a",
              d = n.find(".dropdown-menu" + a);
            if (d.length) {
              var l = d.index(o.target);
              38 == o.which && l > 0 && l--,
                40 == o.which && l < d.length - 1 && l++,
                ~l || (l = 0),
        ...
        this.bodyIsOverflowing &&
          ...
          t(this.fixedContent).each(function (e, i) {
            ...
            t(i)
              ...
              .css("padding-right", parseFloat(s) + o + "px");
          }));
      }),
      (o.prototype.resetScrollbar = function () {
        this.$body.css("padding-right", this.originalBodyPad),
          t(this.fixedContent).each(function (e, o) {
            var i = t(o).data("padding-right");
            t(o).removeData("padding-right"),
              (o.style.paddingRight = i ? i : "");
          });
      }),
      ...
      t(document).on(
        ...
        function (o) {
          var i = t(this),
            ...
            a = r.data("bs.modal")
              ? "toggle"
              : t.extend({ remote: !/#/.test(n) && n }, r.data(), i.data());
