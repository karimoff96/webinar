!(function (e) {
  ...
  var i = function (t, i) {
    ...
    (this.element = e(t)),
      ...
      (this.format = a.parseFormat(
        i.format ||
          this.element.data("date-format") ||
          s[this.language].format ||
          a.getDefaultFormat(this.formatType, "input"),
        this.formatType
      )),
      (this.isInline = !1),
      (this.isVisible = !1),
      ...
      (this.linkFormat = a.parseFormat(
        i.linkFormat ||
          this.element.data("link-format") ||
          a.getDefaultFormat(this.formatType, "link"),
        this.formatType
      )),
      (this.minuteStep = i.minuteStep || this.element.data("minute-step") || 5),
      (this.show59minute = i.show59minute || false),
      (this.pickerPosition =
        i.pickerPosition ||
      ...
      (this.picker = e(3 == this.bootcssVer ? a.templateV3 : a.template)
  ...
  (i.prototype = {
      ...
      if (!this.isInline) {
        ...
        (n =
          ...
          this.component
            ...
            : ((i = this.element.offset()), (a = i.left)),
          ...
          (s -= n.top),
          (a -= n.left),
          this.picker.css({ top: s, left: a, zIndex: h });
      }
    },
    update: function () {
      var e,
      ...
      if (null != this.date && null != this.viewDate) {
        ...
        if (
          (this.picker
            ...
            .text(s[this.language].months[h] + " " + n),
          ...
          this.picker
            .find(".datetimepicker-hours thead th:eq(1)")
            .text(o + " " + s[this.language].months[h] + " " + n),
            this.picker
              .find(".datetimepicker-minutes thead th:eq(1)")
              .text(o + " " + s[this.language].months[h] + " " + n);
        this.picker
        ...
        for (var C, k = []; y.valueOf() < M; )
          y.getUTCDay() == this.weekStart && k.push("<tr>"),
            (C = ""),
            y.getUTCFullYear() < n ||
            (y.getUTCFullYear() == n && y.getUTCMonth() < h)
              ? (C += " old")
              : (y.getUTCFullYear() > n ||
                  (y.getUTCFullYear() == n && y.getUTCMonth() > h)) &&
                (C += " new"),
            this.todayHighlight &&
              y.getUTCFullYear() == v.getFullYear() &&
              y.getUTCMonth() == v.getMonth() &&
              y.getUTCDate() == v.getDate() &&
              (C += " today"),
            y.valueOf() == p && (C += " active"),
            (y.valueOf() + 864e5 <= this.startDate ||
              y.valueOf() > this.endDate ||
              -1 !== e.inArray(y.getUTCDay(), this.daysOfWeekDisabled)) &&
              (C += " disabled"),
          ...
          (C = ""),
            ...
            this.showMeridian && 2 == s[this.language].meridiem.length
              ? ((b =
                ...
                23 == F && k.push("</fieldset>"))
              : ((U = F + ":00"),
                k.push('<span class="hour' + C + '">' + U + "</span>"));
        }
        ...
        for (var F = 0; 60 > F; F += this.minuteStep) {
          if (this.show59minute && this.minuteStep == 5 && F == 55) {
            F = 59;
          }
          var S = t(n, h, o, r, F, 0);
          (C = ""),
            S.valueOf() < this.startDate || S.valueOf() > this.endDate
              ? (C += " disabled")
              : Math.floor(d / this.minuteStep) ==
                  Math.floor(F / this.minuteStep) && (C += " active"),
            this.showMeridian && 2 == s[this.language].meridiem.length
              ? ((b =
                  12 > r
                    ? s[this.language].meridiem[0]
        ...
        x == n && H.eq(this.date.getUTCMonth()).addClass("active"),
          (l > n || n > u) && H.addClass("disabled"),
          n == l && H.slice(0, c).addClass("disabled"),
          n == u && H.slice(m + 1).addClass("disabled"),
          (k = ""),
        ...
        case 4:
          this.picker
            ...
            this.picker
              .find(".next")
              .css(
                1 / 0 !== this.endDate && t >= this.endDate.getUTCFullYear()
                  ? { visibility: "hidden" }
                  : { visibility: "visible" }
              );
      }
    ...
    showMode: function (e) {
      ...
      this.picker
        .find(">div")
        .hide()
        .filter(".datetimepicker-" + a.modes[this.viewMode].clsName)
        .css("display", "block"),
        this.updateNavArrows();
    },
    reset: function () {
    ...
    a = {
      ...
      parseDate: function (a, n, h, o) {
        ...
        if (
          ...
          /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(a) &&
        ...
        if (
              ...
              switch (d) {
                case "MM":
                  (v = e(s[h].months).filter(function () {
                    var e = this.slice(0, u[m].length),
                      t = u[m].slice(0, e.length);
                    return e == t;
                  })),
          ...
          for (var y, m = 0; m < f.length; m++)
            (y = f[m]), y in g && !isNaN(g[y]) && w[y](a, g[y]);
        }
        return a;
      },
      formatDate: function (t, i, n, h) {
        ...
        if ("standard" == h)
          (o = {
            ...
            p:
              2 == s[n].meridiem.length
                ? s[n].meridiem[t.getUTCHours() < 12 ? 0 : 1]
                : "",
            h: t.getUTCHours(),
            i: t.getUTCMinutes(),
            s: t.getUTCSeconds(),
          ...
          (o = {
            ...
            S:
              t.getUTCDate() % 10 <= s[n].suffix.length
                ? s[n].suffix[(t.getUTCDate() % 10) - 1]
                : "",
            a:
              2 == s[n].meridiem.length
                ? s[n].meridiem[t.getUTCHours() < 12 ? 0 : 1]
